...
description: >
  Create interactive, personalised personal financial plans for Indian startup founders and
  early-stage entrepreneurs. Use this skill whenever an Indian founder, CEO, or entrepreneur
  asks about their personal finances, financial planning, money management, saving for
  retirement, personal runway while bootstrapping, wealth building, or liquidity concerns.
  Also trigger when someone mentions "founder salary", "paying myself", "personal savings",
  "ITR filing", "old vs new tax regime", "80C investments", "PPF", "NPS", "ELSS", "term
  insurance", "health insurance after leaving job", "ESOP taxation", "advance tax", "SIP",
  "net worth", "mutual funds", or "founder financial health". Even casual questions like
  "how should I manage money as a founder in India?" or "I'm drawing very little salary —
  what should I do?" should trigger this skill. The skill starts with a structured interview,
  gives live suggestions with options, and ends with a polished Word (.docx) document.
---
